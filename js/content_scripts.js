    ...
    port.onMessage.addListener(async function(msg,port) {
        if (msg.reget == "true") {
            ...
            await port.postMessage({
                ...
                //営業副担当
                SubAccount: getTextBoxText('form_name_120_1') + ' ' + getTextBoxText('form_name_120_2'),
                //給与
                ...
                //日払い日額
                Advance: getTextBoxText('form_name_54'),
                //交通費
                ...
                //車種
                Car_Type : document.getElementsByName('form_name_4')[0].parentElement.parentElement.outerHTML,
                //車種特記
                Cartype_Detail : getTextBoxText('form_name_7'),
                //必要免許
                Required_Licenses: document.getElementsByName('form_name_99')[0].parentElement.parentElement.outerHTML,
                //必須資格
                ...
                //面接・待ち合わせ場所
                Waiting_Location: getTextBoxText('form_name_33'),
                //待ち合わせ住所
                Waiting_Address: getTextBoxText('form_name_34'),
                //面接時間の注意事項
                Interview_Time_Considerations: getTextBoxText('form_name_35'),
                //面接注意事項
