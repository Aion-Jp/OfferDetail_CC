...
function setContents(msg) {
    ...
    //営業副担当
    document.getElementById('subaccount').textContent = msg.SubAccount;
    //給与
    ...
    //日払い日額
    document.getElementById('advance').textContent = msg.Advance + '円';
    //交通費
    ...
    //車種
    setCheckElements('cartype',msg.Car_Type);
    //車種特記
    document.getElementById('cartype_detail').textContent = msg.Cartype_Detail;
    //必要免許
    setCheckElements('required_licenses',msg.Required_Licenses);
    //必須資格
    ...
    //面接・待ち合わせ場所
    document.getElementById('waiting_location').textContent = msg.Waiting_Location;
    //待ち合わせ住所
    document.getElementById('waiting_address').textContent = msg.Waiting_Address;
    //面接時間の注意事項
    document.getElementById('interview_time_considerations').value = msg.Interview_Time_Considerations;
    //面接注意事項
...
function clearContents(){
	...
	document.getElementById('job_status_id').textContent = "";
    ...
    document.getElementById('subaccount').textContent = "";
    ...
    document.getElementById('required_licenses').innerHTML = "";
    ...
    document.getElementById('waiting_location').textContent = "";
    document.getElementById('waiting_address').textContent = "";
    document.getElementById('interview_time_considerations').value = "";
    ...
    document.getElementById('transportation_method').innerHTML = "";
